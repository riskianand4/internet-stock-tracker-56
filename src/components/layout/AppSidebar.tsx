...
import { Package, BarChart3, Plus, Wifi, Home, TrendingUp, HardDrive, Users, Shield, Settings, Database, AlertTriangle, FileText, Monitor, Key, Bell, Download } from 'lucide-react';
...
const adminMenuItems = [{
  ...
  icon: Download,
  roles: ['user', 'admin', 'superadmin'],
  description: "Quick report generation"
}];
