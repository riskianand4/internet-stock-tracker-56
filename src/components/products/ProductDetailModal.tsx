...
import { Eye, Edit3, Save, X, Package, MapPin, User, Calendar, TrendingUp, AlertTriangle } from 'lucide-react';
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {mode === 'view' ? isAdmin && <Button variant="outline" size="sm" onClick={() => onModeChange('edit')} className="gap-2">
                    <Edit3 className="w-4 h-4" />
                    Edit
                  </Button> : <Button variant="outline" size="sm" onClick={() => onModeChange('view')} className="gap-2">
        ...
        <Tabs defaultValue="details" className="space-y-4">
          ...
          <TabsContent value="details" className="space-y-4">
            {mode === 'view' ? <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card>
                  <CardHeader>
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    {product.image && <div>
                        ...
                        <div className="mt-2">
                          <img src={product.image} alt={product.name} className="w-32 h-32 object-cover rounded-lg border" onError={e => {
                      e.currentTarget.src = '';
